 ...
 ********************************************************************/
bool CBits::IsBitSet(DWORD dword_bits, int x)
{
 ...
 ********************************************************************/
void CBits::SetBit(DWORD_BITS &dword_bits, int x)
{
 ...
 ********************************************************************/
int CBits::GetNextBitSet(DWORD const &dword_bits, int iStart, int iStop)
{
	int i;
 ...
 ********************************************************************/
int CBits::GetNextBitSet(DWORD_BITS const &dword_bits, int iStart, int iStop)
{
